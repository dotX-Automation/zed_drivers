...
void ZEDDriverNode::camera_routine()
{
  ...
  cv::Mat left_frame_cv = sl_to_cv(left_frame);
  cv::Mat right_frame_cv = sl_to_cv(right_frame);
  cv::Mat left_frame_cv_sd = sl_to_cv(left_frame_sd);
  cv::Mat right_frame_cv_sd = sl_to_cv(right_frame_sd);
 ...
 */
PoseKit::Pose ZEDDriverNode::positional_tracking(sl::Pose & camera_pose)
{
  // Parse pose data
  Header pose_header{};
